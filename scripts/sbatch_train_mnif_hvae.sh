...
python train_inr.py --config cfgs/train_mnif_shapenet.yml --epochs 100 --batch_size 16 --save_every_n_steps 1000 --dataset_root /scratch/xiaoyu/data/ --wandb --log_dir logs --cache_latents --vae hierarchical_vae