...
python train_inr.py --config cfgs/train_functa_shapenet.yml --epochs 100 --batch_size 40 --save_every_n_steps 1000 --dataset_root /scratch/xiaoyu/data/ --wandb --log_dir logs