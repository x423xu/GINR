...
def get_data(args, rank):
    ...
    if args.ddp:
        sampler = DistributedSampler(dataset, num_replicas=args.num_proc_node * args.num_process_per_node, rank=rank)
...
def train(args):
    ...
    '''Init dataloader'''
    train_loader, data_meta = get_data(args, current_rank)
